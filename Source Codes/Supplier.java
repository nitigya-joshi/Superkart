...
public class Supplier extends Entity {
    ...
    public void importData() throws FileNotFoundException, SQLException {
        ...
        Scanner s = new Scanner(new BufferedReader(new FileReader("Tables/Supplier.csv")));
        String query ;
        String temp;

        while(s.hasNext()){
            temp = s.nextLine();
            query = "insert into Supplier values (" + temp + ")";
    ...
    public void add(String[] args) throws ClassNotFoundException, SQLException {
        ...
        if (args[0].equals("-add") && args[1].equals("Supplier")) {

            Class.forName("com.mysql.cj.jdbc.Driver");
            String query = "insert into SUPPLIER values('" + args[2] + "','" + args[3] + "','" + args[4] + "','"
    ...
    public void search(String args[]) throws ClassNotFoundException, SQLException {
        ...
        if (args[0].equals("-search") && args[1].equals("Supplier")) {
            if (args[2].equals("-on") && args[3].equals("-all")) {
                ...
                op = args[4];
                val = args[5];
                query = "select * from Supplier where " + att;
                ...
                if (args[j].equals("-all")) {
                    ...
                    query = query + " " + "from SUPPLIER";

                    ResultSet rs = st.executeQuery(query);

                    while (rs.next()) {
                        for (i = 0; i < j - 4; i++) {
                            System.out.printf("%-16s ", rs.getString(temp[i]));
                        }
                        System.out.println();
                    }
                    ...
                    query = query + " " + "from SUPPLIER where " + att;
    ...
    public void delete(String[] args) throws ClassNotFoundException, SQLException {
        ...
        if (args[0].equals("-delete") && args[1].equals("Supplier") && args[2].equals("-on")) {
            if (args[3].equals("-all")) {
                ...
                String op = args[4];
                String val = args[5];
                query = "delete from SUPPLIER where " + att;
    ...
    public void update(String[] args) throws ClassNotFoundException, SQLException {
        ...
        if (args[0].equals("-update") && args[1].equals("Supplier") && args[2].equals("-set")) {
